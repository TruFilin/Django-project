...
from .views import home, login_view, edit_forklift,delete_complaint,add_technical_service,delete_technical_service,add_complaint, delete_forklift, add_forklift, logout_view, search_forklift, forklift_list, technical_service_list, complaint_list
